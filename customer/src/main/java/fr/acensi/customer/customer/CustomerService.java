...
import fr.acensi.customer.exception.CustomerNotFoundException;
...
public class CustomerService {
    ...
    public void updateCustomer(CustomerRequest request) {
        var customer = repository.findById(request.id())
                .orElseThrow(()-> new CustomerNotFoundException(format("Can not update customer with id : %s", request.id())));
